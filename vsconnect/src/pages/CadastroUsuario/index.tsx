...
function CadastroUsuario() {
    ...
    const [nome, setNome] = useState<string>(""); // state que contém a opção Nome
    const [email, setEmail] = useState<string>(""); // state que contém a opção Email
    const [senha, setSenha] = useState<string>(""); // state que contém a opção Senha
    const [cep, setCep] = useState<string>(""); // state que contém a opção cep
    const [foto, setFoto] = useState<any>(); // state que contém a opção foto
    const [logradouro, setLogradouro] = useState<string>(""); // state que contém a opção logradouro
    const [numero, setNumero] = useState<string>(""); // state que contém a opção nimero
    const [bairro, setBairro] = useState<string>(""); // state que contém a opção bairro
    const [cidade, setCidade] = useState<string>(""); // state que contém a opção cidade
    const [uf, setUf] = useState<string>(""); // state que contém a opção  uf

    function cadastrarUsuario(event: any) {
        event.preventDefault();
        //utiliza formDATA PARA SUBIR UM ARQUIVO
        ...
        function verificarCampoUpload(event: any) {
            ...
            //Atualiza o state com o valor do file upload
