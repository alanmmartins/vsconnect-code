...
function CadastroServico( ) {
    const [infoServico, setInfoServico] = useState<{}>(Object)
    ...
    const [skillSelecionadas, setTechsSelecionadas] = useState<string[]>([]); // Array (lista) para armazenar as skills selecionadas
    ...
    function adicionarTech() {
        ...
        if (select === "") {
            ...
            if (skillSelecionadas.includes(select)) {
                ...
                let novaListaSkillsSelecionadas = [...skillSelecionadas];
...
function excluirTech(skill: string) {
    ...
    //A variavel novaListaSkillsSelecionadas armazena skills diferente da skill que o usuário clicou para ser excluida.
     const novaListaSkillsSelecionadas = skillSelecionadas.filter(item => item !== skill); 

    //Atualiza o valor do state skillsSelecionadas, com o valor da variavel novaListaSkillsSelecionadas 
    setskillSelecionadas(novaListaSkillsSelecionadas);
    setInfoServico({ ...infoServico, techs: novaListaSkillsSelecionadas })
}
;*/
                ...
                <form className="cad_serv_formulario" action="" onSubmit={cadastrarServico}>
                    ...
                    <div className="cad_serv_box_skills">
                        ...
                        <div id="cad_lista_skills">
                            {
                                skillSelecionadas.length > 0 ? skillSelecionadas.map((el: any, index: number) => {
